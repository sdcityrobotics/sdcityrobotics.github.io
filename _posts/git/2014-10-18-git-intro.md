...
<div style="float: right; width: 20%; height: 100%; display: inline-block; vertical-align: middle;">
<a href="http://git-scm.com"><img alt="Git-Logo" src="{{ BASE_PATH }}/assets/images/Git-Logo-2Color.png" style="max-width: 100%; vertical-align: middle; position: relative; top: 50%; transform: translateY(-50%);" /></a>
</div>
<!--<br style="clear: left;" />-->
</div>
